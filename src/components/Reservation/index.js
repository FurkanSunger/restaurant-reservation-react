            ...
            <div className="modal-body">
              <div className="container text-center">
                ...
                <div className="d-flex flex-column justify-content-center align-items-center mt-5">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <PrimaryText>
                      Your booking request is waiting to be confirmed. Updates
                      will be sent to the phone number you provided.
                    </PrimaryText>
                  </div>
                </div>
              </div>
        ...
        <div className="row p-4">
          <div className="col-lg-6">
            <AvailableTimesWrapper className="color-light">
              <SectionTitle className="secondary-font color-danger">
              ...
              <div className="d-flex flex-column justify-content-center align-items-start w-100">
                <PhoneEmailLabel>
                  <FaPhoneAlt className="color-danger" /> - (546) 937 5480
                </PhoneEmailLabel>
                <PhoneEmailLabel>
          ...
          <div className="col-lg-6">
            <BookingWrapper className="color-light">
              ...
              <ReservationForm className="mt-3" onSubmit={bookATable}>
                ...
                <NormalButton
                  data-toggle={
                    fullName && phone && date && time && guests ? "modal" : ""
                  }
                  data-target={
                    fullName && phone && date && time && guests
                      ? "#finishModal"
                      : ""
                  }
                >
